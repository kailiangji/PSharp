...
namespace Microsoft.PSharp.TestingServices
{
    ...
    internal static class CodeCoverageInstrumentation
    {
        ...
        internal static void Instrument(Configuration configuration)
        {
            ...
            var assemblyNames = new HashSet<string>(DependencyGraph.GetDependenciesToPSharp(configuration)
        ...
        private static bool Instrument(string assemblyName)
        {
            int exitCode;
            string error;
            Output.WriteLine($"Instrumenting {assemblyName}");
            ...
            {
                Error.Report($"[PSharpTester] 'VSInstr' failed to instrument '{assemblyName}'.");
        ...
        internal static void Restore(string assemblyName)
        {
            ...
            catch (IOException ex)
            {
                ...
                Error.Report($"[PSharpTester] Failed to restore non-instrumented '{assemblyName}': {ex.Message}.");
            }
        }
